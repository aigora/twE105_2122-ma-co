...
int menu(Window window, Textures tex, int personaje, int stage, int sonido)
{
	...
	while(stage!=0)
    {
        ...
        while(stage==1)
        {
            ...
            //Dibuja la imagen
            SDL_RenderCopy(window.renderer, tex.menu, NULL, NULL);
    ...
    switch (stage)
    {
        case 3://SCORES
            while(stage==3)
            {
                ...
                SDL_RenderCopy(window.renderer, tex.prox, NULL, NULL);
                SDL_RenderPresent(window.renderer);
        ...
        case 4://AJUSTES
            while(stage==4)
            {
                ...
                if (sonido == 0)
                    {
                    SDL_RenderCopy(window.renderer, tex.ajustes, NULL, NULL);
                    }
                if (sonido == 1)
                    {
                    SDL_RenderCopy(window.renderer, tex.ajusnos, NULL, NULL);
                    }
        ...
        case 6://PERSONAJE
                    while(stage==6)
                    {
                        if (personaje == 1)
                        {
                            ...
                            SDL_RenderCopy(window.renderer, tex.personaje1, NULL, NULL);
                            SDL_RenderPresent(window.renderer);
                        ...
                        else if (personaje == 2)
                        {
                            ...
                            SDL_RenderCopy(window.renderer, tex.personaje2, NULL, NULL);
                            SDL_RenderPresent(window.renderer);
                        }
                        else
                        {
                            ...
                            SDL_RenderCopy(window.renderer, tex.personaje3, NULL, NULL);
                            SDL_RenderPresent(window.renderer);
                        }
